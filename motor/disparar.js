...
+ '.meta a{color:#53bdeb;text-decoration:none}.wa-num{color:#25d366;font-weight:700;font-size:.96rem}textarea{width:100%;background:#0b141a;color:#e9edef;border:1px solid #2a3942;border-radius:8px;padding:12px;font-family:inherit;font-size:.92rem;min-height:120px;resize:vertical}'
